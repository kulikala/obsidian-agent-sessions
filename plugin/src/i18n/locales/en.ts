...
export const en = {
	...
	"settings.agents.env.desc": "Environment variables passed at launch, one KEY=VALUE per line.",
	"settings.agents.detect.name": "Find again",
	"settings.agents.detected.found": "Found: {path}",
	"settings.agents.detected.foundWithVersion": "Found: {path} ({version})",
	"settings.agents.detected.notFound": "Not found.",
	"settings.agents.detected.enable": "Enable",
	"settings.agentSessionsPath.name": "agent-sessions location",
	"settings.agentSessionsPath.desc": "Leave empty to use ~/bin/agent-sessions.",
	...
	"settings.submitKey.desc":
		"The key that sends your message. If you pick anything other than Enter, Enter inserts a newline.",
	"settings.submitKey.currentUnreadable": "Can't read Claude Code's settings ({path}).",
	"settings.submitKey.currentCustom": "Claude Code's setting: Enter is bound to “{raw}”.",
	"settings.submitKey.currentNewline": "Claude Code's setting: Enter inserts a newline.",
	"settings.submitKey.currentSubmit": "Claude Code's setting: Enter sends (default).",
	...
	"stats.window.nDay": "{n}-day window",
	"stats.window.nHour": "{n}-hour window",
	"stats.window.nMinute": "{n}-minute window",
	...
	"stats.categoryBar.title": "By category ({window})",
	...
	"stats.pace.overPace": "At this pace you'll run out {when} ({beforeReset})",
	"stats.pace.tomorrow": "tomorrow {time}",
	"stats.pace.beforeReset.now": "just before reset",
	"stats.pace.beforeReset.minutes": "{m}m before reset",
	"stats.pace.beforeReset.hours": "{h}h before reset",
	"stats.pace.beforeReset.hoursMinutes": "{h}h {m}m before reset",
	"stats.pace.beforeReset.days": "{d}d before reset",
	"stats.pace.beforeReset.daysHours": "{d}d {h}h before reset",
	...
	"stats.pace.overPaceGuideHour": "Stay under {pct} per remaining hour (about {cost}/hour)",
	"stats.pace.overPaceGuideHourNoCost": "Stay under {pct} per remaining hour",
