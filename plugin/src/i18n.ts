...
const ja = {
	...
	"settings.pythonPath.desc": "空欄時のデフォルト: /usr/bin/python3",
...
const en: Record<MessageKey, string> = {
	...
	"settings.pythonPath.desc": "Default when empty: /usr/bin/python3",
